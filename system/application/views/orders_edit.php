<script type="text/javascript">
	...
	function checkPrice(field) {
		...
		var pattern1 = /[^\d\.\,\$]/; 	// non-integer other than a decimal point or comma or $
		...
		<div class="form-padding">
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="entry_cell">
                        <input type="text" class="price" id="total_total" name="total_order" size="10" />
                    </td>
                </tr>
            </tfoot>
            <tbody>
                ...
                echo '<tr>';
                    ...
                    echo '</td>';
                    echo '<td class="entry_cell">';
                        echo '<input type="text" class="price changetotal" style="text-align:right;" name="od_unit_price_'. $item->item_linenum . '" value="' . number_format($item->item_unitprice,2) . '" size="10" />';
                    echo '</td>';
                    echo '<td class="entry_cell">';
                        echo '<input type="text" class="price sumtotal" style="text-align:right;" name="od_total_price_'. $item->item_linenum . '" size="10" value="' . number_format($item->item_quantity * $item->item_unitprice,2) . '" />';
                    echo '</td>';
                    echo '<td class="entry_cell">';
